                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview" style="background-image: url({{ getImage(imagePath()['product']['path'].'/',imagePath()['product']['size']) }})">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" step="any" placeholder="0" name="price" value="{{ old('price') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" step="0.01" placeholder="0" name="discount" value="{{ old('discount') }}">
                                ...
                                <div class="form-group col-xl-6">
                                    ...
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" id="featured" data-on="@lang('Enable')" data-off="@lang('Disable')" name="featured">
                                </div>

                                <div class="form-group col-xl-6">
                                    <label for="status">@lang('Status')</label>
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" id="status" data-on="@lang('Enable')" data-off="@lang('Disable')" name="status" checked>
                                </div>
                            </div>
                        </div>
                    </div>
