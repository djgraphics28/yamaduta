            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.brand.index')}}">
                    <a href="{{route('admin.brand.index')}}" class="nav-link ">
                        <i class="menu-icon las la-signature"></i>
                ...
                <li class="sidebar-menu-item {{menuActive(['admin.product.index', 'admin.product.add.page', 'admin.product.update.page', 'admin.product.image.page'])}}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.orders*',3)}}">
                        ...
                        @if($processing_orders_count > 0 || $pending_orders_count > 0)
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.orders.processing')}} ">
                                <a href="{{route('admin.orders.processing')}}" class="nav-link">
                                    ...
                                    @if($processing_orders_count)
                                    <span class="menu-badge pill bg--primary ml-auto">{{$processing_orders_count}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.orders.cod')}} ">
                                <a href="{{route('admin.orders.cod')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('COD Orders')</span>
                                </a>
                            </li>
