            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Order ID')
                            <span class="font-weight-bold">{{$order->order_track}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Product Name')
                            <span class="font-weight-bold">{{$order->product->name}}({{$order->product->sku}})</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Order Qty')
                            @if ($order->product->stock < $order->qty)
                            <span class="font-weight-bold text--danger">{{$order->qty}}</span>
                            @else
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Product Stock')
                            <span class="font-weight-bold">{{$order->product->stock}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
