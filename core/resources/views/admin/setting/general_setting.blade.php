                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('Hot Deal Discount')</label>
                                <div class="input-group">
                                    <input type='text' name="hot_deal_discount" class="form-control form-control-lg" value="{{$general->hot_deal_discount}}"/>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('City Name')</label>
                                <input class="form-control form-control-lg" type="text" name="city" value="{{$general->city}}" required>
                            </div>

                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold"> @lang('Shipping Charge The City') <code>@lang('(Put -1 for free shipping)')</code> </label>

                                <div class="input-group">
                                    <input class="form-control form-control-lg" type="text" name="shipping_charge_inside" value="{{getAmount($general->shipping_charge_inside)}}" required>
                            ...
                            <div class="form-group col-md-4">
                                <label class="form-control-label font-weight-bold">@lang('Shipping Charge The City')   <code>@lang('(Put -1 for free shipping)')</code></label>
                                <div class="input-group">
                                    <input class="form-control form-control-lg" type="text" name="shipping_charge_outside" value="{{getAmount($general->shipping_charge_outside)}}" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span>{{ $general->cur_text }}</span>
                                        </div>
