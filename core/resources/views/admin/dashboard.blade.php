    ...
    <div class="row mb-none-30">
            ...
            <div class="dashboard-w1 bg--success b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Verified Users')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$otherData['product']}}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--11 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$otherData['category']}}</span>
                    </div>
                    <div class="desciption">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$otherData['brand']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Brands')</span>
                    </div>

                    <a href="{{route('admin.brand.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$order['pending']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Pending Orders')</span>
                    </div>

                    <a href="{{route('admin.orders.pending')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--18 b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$order['processing']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Processing Orders')</span>
                    </div>

                    <a href="{{route('admin.orders.processing')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--green b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$order['delivered']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Delivered Orders')</span>
                    </div>

                    <a href="{{route('admin.orders.delivered')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--danger b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$order['cancel']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Cancelled Orders')</span>
                    </div>

                    <a href="{{route('admin.orders.cancelled')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="widget-four b-radius--10 bg--white p-4 box--shadow2 hover--effect1">
                <div class="widget__icon bg--success">
                    <i class="las la-money-bill"></i>
                </div>
                <div class="widget__content">
                    <p class="mb-2">@lang('Total Payment')</p>
                    <h4>{{showAmount($payment['total_deposit_amount'])}} {{$general->cur_text}}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="widget-four b-radius--10 bg--white p-4 box--shadow2 hover--effect1">
                ...
                <div class="widget__content">
                    <p class="mb-2">@lang('Total Payment Charge')</p>
                    <h4>{{showAmount($payment['total_deposit_charge'])}} {{$general->cur_text}}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 mb-30">
            <div class="widget-four b-radius--10 bg--white p-4 box--shadow2 hover--effect1">
                <div class="widget__icon bg--warning">
                    <i class="las la-pause-circle"></i>
                </div>
                <div class="widget__content">
                    <p class="mb-2">@lang('Pending Payment')</p>
                    <h4>{{$payment['total_deposit_pending']}}</h4>
                </div>
            </div>
        </div>
