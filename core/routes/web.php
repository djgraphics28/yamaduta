...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('brand', 'BrandController@brand')->name('brand.index');
        ...
        Route::get('add/product/page', 'ProductController@addPage')->name('product.add.page');
        Route::post('add/product', 'ProductController@add')->name('product.add');
        Route::get('update/product/page/{id}', 'ProductController@updatePage')->name('product.update.page');
        Route::post('update/product', 'ProductController@update')->name('product.update');
        Route::post('make-hot-deal/{id}', 'ProductController@hotDeal')->name('product.hot.deal');

        Route::get('product/images/{id}', 'ProductController@imagePage')->name('product.image.page');
        Route::post('delete/product/image', 'ProductController@deleteImage')->name('product.image.delete');
        Route::post('add/product/image', 'ProductController@addImage')->name('product.image.add');

        //manage orders
        Route::get('all/orders', 'ManageOrderController@allOrders')->name('orders');
        Route::get('pending/orders', 'ManageOrderController@pending')->name('orders.pending');
        Route::get('processing/orders', 'ManageOrderController@processing')->name('orders.processing');
        Route::get('delivered/orders', 'ManageOrderController@delivered')->name('orders.delivered');
        Route::get('cancelled/orders', 'ManageOrderController@cancelled')->name('orders.cancelled');
        Route::get('cod/orders', 'ManageOrderController@codOrders')->name('orders.cod');
        Route::get('order-details/{id}', 'ManageOrderController@orderDetails')->name('orders.details');
        Route::post('order-process/{id}', 'ManageOrderController@markAsProcess')->name('order.process');
        Route::post('order-deliver/{id}', 'ManageOrderController@markAsDelivered')->name('order.deliver');
        Route::post('order-cancel', 'ManageOrderController@cancel')->name('order.cancel');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::any('payment/history', 'UserController@depositHistory')->name('deposit.history');

            //order operation
            Route::get('order-history', 'OrderController@orders')->name('orders');
...
Route::get('faq/page', 'SiteController@faq')->name('faq');
...
Route::get('product-details/{id}/{slug}', 'SiteController@productDetails')->name('product.details');
Route::get('checkout/{id}/{slug}', 'SiteController@checkOut')->name('checkout')->middleware(['auth','checkStatus']);

Route::get('placeholder-image/{size}', 'SiteController@placeholderImage')->name('placeholder.image');
Route::get('/{policy}/page/{id}', 'SiteController@page')->name('policy.details');
